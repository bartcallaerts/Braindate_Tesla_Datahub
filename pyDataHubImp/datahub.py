...
from .datavault import CevoraDataVault
...
class CevoraDataHub(DataHub):

    def __init__(self, path, dbutils, initWithCreation=False):
        super().__init__(path, dbutils, initWithCreation)

        self.dataVault = CevoraDataVault(self.dataVaultPath, self.dbutils, "CevoraDataHub", initWithCreation)
